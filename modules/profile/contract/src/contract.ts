 ...
 *
 * Ce fichier est la seule description du profil dans toute la plateforme. L'API Hono le sert,
 ...
 * sont de toute façon déconseillées sur un profil, car elles ouvrent la porte à la discrimination.
 */
export interface Profil {
  readonly nom: string;
  readonly titre: string;
  /** La phrase d'accroche, entre guillemets sur le profil papier. */
...
export interface Experience {
   ...
   *
   * Facultatif : les postes les plus anciens du profil papier n'en portent aucun, et un intitulé
...
/** Le profil complet — exactement le corps de `GET /api/profile`. */
...
export interface ErreurApi {
  readonly code: 'PROFILE_INVALIDE';
